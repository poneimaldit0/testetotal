...
// WhatsApp is now handled inside ContatoSection
const noopWhatsApp = (_telefone: string, _nome: string, _orcamentoId: string) => {};

export const ListaOrcamentosAbertos: React.FC = () => {
