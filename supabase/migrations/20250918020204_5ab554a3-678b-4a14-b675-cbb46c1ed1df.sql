-- Remover trigger e função problemáticos primeiro
DROP TRIGGER IF EXISTS trigger_notificar_revisao_concluida ON public.revisoes_propostas_clientes;
DROP FUNCTION IF EXISTS public.notificar_revisao_concluida() CASCADE;

-- Agora corrigir a revisão pendente
...
-- Inserir o item extra que foi perdido
