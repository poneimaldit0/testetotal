-- Atualizar função para relatório de funil de vendas com status corretos
...
WITH dados_funil AS (
  SELECT 
    CASE 
      WHEN cf.status_acompanhamento IN ('1_contato_realizado', '2_contato_realizado', '3_contato_realizado', '4_contato_realizado', '5_contato_realizado') THEN 'Contatos Iniciais'
      WHEN cf.status_acompanhamento IN ('cliente_respondeu_nao_agendou', 'nao_respondeu_mensagens') THEN 'Resposta do Cliente'
