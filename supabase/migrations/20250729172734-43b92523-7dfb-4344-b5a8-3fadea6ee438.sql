-- Função para relatório de logins dos fornecedores
CREATE OR REPLACE FUNCTION public.relatorio_logins_fornecedor(
...
RETURNS TABLE(
  ...
  total_logins_desde_inicio bigint,
  total_logins_periodo bigint,
  ultimo_login timestamp with time zone,
  dias_sem_login integer,
  media_logins_mes numeric,
  dias_contrato_total integer,
  dias_contrato_restantes integer
)
LANGUAGE sql
