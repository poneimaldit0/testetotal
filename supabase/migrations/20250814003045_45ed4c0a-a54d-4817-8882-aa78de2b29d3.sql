-- Adicionar novos status às propostas
ALTER TYPE status_proposta_enum ADD VALUE IF NOT EXISTS 'enviada';
ALTER TYPE status_proposta_enum ADD VALUE IF NOT EXISTS 'finalizada';
ALTER TYPE status_proposta_enum ADD VALUE IF NOT EXISTS 'em_revisao';
ALTER TYPE status_proposta_enum ADD VALUE IF NOT EXISTS 'aceita';
ALTER TYPE status_proposta_enum ADD VALUE IF NOT EXISTS 'rejeitada';

-- Adicionar campos para revisões
