-- Corrigir função processar_candidatura_fornecedor removendo FOR UPDATE
-- que estava causando erro de permissão para fornecedores
...
BEGIN
  ...
  -- Contar candidatos atuais com lock em candidaturas_fornecedores
